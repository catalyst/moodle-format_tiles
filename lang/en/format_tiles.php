...
// $string['courseshowtileprogress_link'] = 'Activity_completion_settings#Activity_settings'; // Had to comment out due to test_lang_link_keys_are_in_whitelist test failure. Does not seem to be used elsewhere...
...
// $string['displayfilterbar_link'] = 'Outcomes'; // Had to comment out due to test_lang_link_keys_are_in_whitelist test failure. Does not seem to be used elsewhere...
